...
const EditHouseDetailsModal = ({ houseDefaultValue, refetch }) => {
  console.log(houseDefaultValue);
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const handleHouseInfo = async (data) => {
    try {
      ...
      const houseData = {
        ...
        housId: houseDefaultValue._id,
      };

      const houseInfoResponse = await api.patch(
          ...
          <div className=" my-5">
            <div className="form-control w-full">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.name}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.address}
                className="input input-bordered w-full"
                {...register("address", {
                  required: true,
                })}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                type="text"
                placeholder="City"
                defaultValue={houseDefaultValue?.city}
                className="input input-bordered w-full"
                {...register("city", {
                  required: true,
                })}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.bedrooms}
                className="input input-bordered w-full"
                {...register("bedrooms", {
                  required: true,
                })}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.bathrooms}
                className="input input-bordered w-full"
                {...register("bathrooms", {
                  required: true,
                })}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.roomSize}
                className="input input-bordered w-full"
                {...register("roomSize", {
                  required: true,
                })}
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.availablityDate}
                className="input input-bordered w-full"
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.rentPerMonth}
                className="input input-bordered w-full"
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.phoneNumber}
                className="input input-bordered w-full"
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.discription}
                className="input input-bordered w-full"
...
export default EditHouseDetailsModal;
